                ...
                <div className="container px-4 md:px-6 relative z-10 max-w-3xl mx-auto">
                    ...
                    <div className="bg-slate-900/80 backdrop-blur-md border border-blue-500/30 rounded-2xl p-8 md:p-12 shadow-2xl shadow-blue-900/50">
                        <div className="flex flex-col md:flex-row gap-8 items-center md:items-start mb-8">
                            ...
                            <div>
                                <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">嗨，我是面爸。</h1>
                                <p className="text-xl text-blue-300 font-medium">MM's DAD</p>
                            </div>
                        </div>
                        ...
                        <div className="prose prose-invert prose-lg max-w-none text-slate-300 space-y-6">
                            ...
                            <p>
                                我是一名热衷于用数据和技术解决实际问题的家长。我创建这个网站的初衷，是希望通过可视化的数据和智能化的工具，帮助家长和学生们在升学规划的道路上少走弯路，做出更明智的决策。
                            </p>
                            <p>
                                在这里，你可以找到关于中考投档的模拟演练系统，以及我对教育数据的深度分析和见解。我相信，数据不仅仅是冰冷的数字，它们背后隐藏着通往未来的线索。
                            </p>
                            <p>
                                如果你有任何问题或建议，欢迎通过 Bilibili 或其他方式联系我。让我们一起探索 AI 与教育的无限可能。
                            </p>
                        </div>
